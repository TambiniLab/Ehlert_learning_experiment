...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/lehlert/Documents/PsychoPy/Tambini_2/Files/stimuli/objects_pract/1_lastrun.py',
...
Hort_neg_375 = visual.Line(
    win=win, name='Hort_neg_375',

...
for thisRound in rounds:
    ...
    for thisTrial in trials:
        ...
        xMov=(coord_x_list[looper]/rate)
        yMov=(coord_y_list[looper]/rate)
        ...
        for thisComponent in TrainingComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
       # trials.addData('Outline_red_2.started', Outline_red_2.tStartRefresh)
        #trials.addData('Outline_red_2.stopped', Outline_red_2.tStopRefresh)
        #trials.addData('Outline_black_2.started', Outline_black_2.tStartRefresh)
        #trials.addData('Outline_black_2.stopped', Outline_black_2.tStopRefresh)
        #trials.addData('Stimuli_2.started', Stimuli_2.tStartRefresh)
        #trials.addData('Stimuli_2.stopped', Stimuli_2.tStopRefresh)
    ...
    # set up handler to look after randomisation of conditions etc
    Tests = data.TrialHandler(nReps=1, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Trials.xlsx'),
    ...
    for thisTest in Tests:
        ...
        for thisComponent in TestingComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        Tests.addData('order', looper+1)
        Tests.addData('xCoord', coord_x_list[looper])
        Tests.addData('yCoord', coord_y_list[looper])
        Tests.addData('Error', dist)
        #Tests.addData('Outline_red.started', Outline_red.tStartRefresh)
        #Tests.addData('Outline_red.stopped', Outline_red.tStopRefresh)
        #Tests.addData('Outline_black.started', Outline_black.tStartRefresh)
        #Tests.addData('Outline_black.stopped', Outline_black.tStopRefresh)
        #Tests.addData('Outline_green.started', Outline_green.tStartRefresh)
        #Tests.addData('Outline_green.stopped', Outline_green.tStopRefresh)
        #Tests.addData('Outline_blue.started', Outline_blue.tStartRefresh)
        #Tests.addData('Outline_blue.stopped', Outline_blue.tStopRefresh)
        #Tests.addData('Target.started', Target.tStartRefresh)
        #Tests.addData('Target.stopped', Target.tStopRefresh)
        #Tests.addData('Stimuli.started', Stimuli.tStartRefresh)
        #Tests.addData('Stimuli.stopped', Stimuli.tStopRefresh)
        # store data for Tests (TrialHandler)
        Tests.addData('Mouse.x', Mouse.x)
        Tests.addData('Mouse.y', Mouse.y)
        Tests.addData('Mouse.leftButton', Mouse.leftButton)
        #Tests.addData('Mouse.midButton', Mouse.midButton)
        #Tests.addData('Mouse.rightButton', Mouse.rightButton)
        #Tests.addData('Mouse.time', Mouse.time)
        #Tests.addData('Mouse.clicked_name', Mouse.clicked_name)
        #Tests.addData('Mouse.started', Mouse.tStart)
        #Tests.addData('Mouse.stopped', Mouse.tStop)
        # store data for Tests (TrialHandler)
        Tests.addData('Mouse1.x', Mouse1.x)
        Tests.addData('Mouse1.y', Mouse1.y)
        Tests.addData('Mouse1.leftButton', Mouse1.leftButton)
        #Tests.addData('Mouse1.midButton', Mouse1.midButton)
        #Tests.addData('Mouse1.rightButton', Mouse1.rightButton)
        #Tests.addData('Mouse1.time', Mouse1.time)
        #Tests.addData('Mouse1.clicked_name', Mouse1.clicked_name)
        #Tests.addData('Mouse1.started', Mouse1.tStart)
        #Tests.addData('Mouse1.stopped', Mouse1.tStop)
        # store data for Tests (TrialHandler)
        Tests.addData('Mouse2.x', Mouse2.x)
        Tests.addData('Mouse2.y', Mouse2.y)
        Tests.addData('Mouse2.leftButton', Mouse2.leftButton)
        #Tests.addData('Mouse2.midButton', Mouse2.midButton)
        #Tests.addData('Mouse2.rightButton', Mouse2.rightButton)
        #Tests.addData('Mouse2.time', Mouse2.time)
        #Tests.addData('Mouse2.started', Mouse2.tStart)
        #Tests.addData('Mouse2.stopped', Mouse2.tStop)
        Outline_red.opacity = 0
        Outline_blue.opacity = 0
        Outline_green.opacity = 0
        if looper==runs-1:
        ...
        routineTimer.reset()
        thisExp.nextEntry()
    # completed 1 repeats of 'Tests'
# completed 5 repeats of 'rounds'

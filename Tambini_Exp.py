...
_dataDir = "/Users/lehlert/Documents/PsychoPy/Tambini_2"
...
for thisRound in rounds:
    ...
    for i in criterion_list:
        if criterion_list[i]==1:
            completeFlag=True 
    
    for i in criterion_list:
        if criterion_list[i]==0:
            completeFlag=False 

    if completeFlag==True:
        #display a final message
        completeText = visual.TextStim(win, text= 'Great job, you have completed the final memory test!!\n\n\nPlease alert the experimenter.',font='Arial',pos=(0, 0), height=letter_size, wrapWidth=None, ori=0, color='white', colorSpace='rgb', opacity=1, languageStyle='LTR',depth=0.0)
    ...
    if nRound==2:
        endFirstRoundText = visual.TextStim(win, text = 'Great job, you have completed the memory test for the 1st Learning Block!\n\n\nThe test for the next block will begin in a moment.',font='Arial',pos=(0, 0), height=letter_size, wrapWidth=None, ori=0, color='white', colorSpace='rgb', opacity=1, languageStyle='LTR',depth=0.0)
    ...
    for thisTrial in training:
        ...
        if criterion_list[order_list[looper]]==0:
